...
!function (ZehraApp, $) {
  ...
  ;
  ZehraApp.coms.docReady.push(jqvmap_init); // Charts 
  ...
  var OrganicSearchData = {
    ...
    datasets: [{
      ...
      color: "#798bff",
      background: ZehraApp.hexRGB('#798bff', .25),
  ...
  var SocialMediaData = {
    ...
    datasets: [{
      label: "Social Media",
      color: "#b8acff",
      background: ZehraApp.hexRGB('#b8acff', .25),
      data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
    }]
  };
  var ReferralsData = {
    ...
    datasets: [{
      label: "Referrals",
      color: "#ffa9ce",
      background: ZehraApp.hexRGB('#ffa9ce', .25),
      data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
    }]
  };
  var OthersData = {
    ...
    datasets: [{
      label: "Others",
      color: "#f9db7b",
      background: ZehraApp.hexRGB('#f9db7b', .25),
      data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
    }]
  };
  var BounceRateData = {
  ...
  var PageviewsData = {
    ...
    datasets: [{
      label: "Pageviews",
      color: "#9a89ff",
      background: ZehraApp.hexRGB('#9a89ff', .25),
      data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
    }]
  };
  var NewUsersData = {
  ...
  var analyticOvData = {
    ...
    datasets: [{
      ...
      color: "#798bff",
      dash: 0,
      background: ZehraApp.hexRGB('#798bff', .15),
