...
!function (ZehraApp, $) {
  ...
  var profileBalance = {
    ...
    datasets: [{
      ...
      color: "#798bff",
      background: ZehraApp.hexRGB('#798bff', .3),
  ...
  ZehraApp.coms.docReady.push(function () {
    lineProfileBalance();
  });
  var orderOverview = {
        ...
        options: {
          ...
          scales: {
            yAxes: [{
              ...
              position: ZehraApp.State.isRTL ? "right" : "left",
              ticks: {
                beginAtZero: true,
                fontSize: 11,
                fontColor: '#9eaecf',
              ...
              gridLines: {
                color: ZehraApp.hexRGB("#526484", .2),
                tickMarkLength: 0,
                zeroLineColor: ZehraApp.hexRGB("#526484", .2)
              }
            }],
            xAxes: [{
              display: true,
  ...
  var userActivity = {
    ...
    datasets: [{
      ...
      label: "Referral Join",
      color: ZehraApp.hexRGB("#9cabff", .4),
  ...
  var coinOverview = {
    ...
    datasets: [{
      ...
      label: "Sell Orders",
      color: [ZehraApp.hexRGB('#f98c45', .2), ZehraApp.hexRGB('#9cabff', .4), ZehraApp.hexRGB('#8feac5', .4), ZehraApp.hexRGB('#6b79c8', .4), ZehraApp.hexRGB('#79f1dc', .4)],
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), "#6576ff"],
      //@v2.0
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), "#6576ff"],
      //@v2.0
  ...
  var totalSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [ZehraApp.hexRGB("#aea1ff", .2), ZehraApp.hexRGB("#aea1ff", .2), ZehraApp.hexRGB("#aea1ff", .2), ZehraApp.hexRGB("#aea1ff", .2), ZehraApp.hexRGB("#aea1ff", .2), "#aea1ff"],
      //@v2.0
      data: [8200, 7800, 9500, 5500, 9200, 9690]
    }]
  };
  ...
  var supportStatus = {
    ...
    datasets: [{
      ...
      label: "Open",
      color: [ZehraApp.hexRGB('#f98c45', .4), ZehraApp.hexRGB('#9cabff', .4), ZehraApp.hexRGB('#8feac5', .4), ZehraApp.hexRGB('#6b79c8', .4), ZehraApp.hexRGB('#79f1dc', .4)],
      data: [66, 74, 92, 32, 26]
    }, {
      label: "Pending",
      color: [ZehraApp.hexRGB('#f98c45', .2), ZehraApp.hexRGB('#9cabff', .2), ZehraApp.hexRGB('#8feac5', .2), ZehraApp.hexRGB('#6b79c8', .2), ZehraApp.hexRGB('#79f1dc', .2)],
      data: [66, 74, 92, 21, 9]
    }]
  };
