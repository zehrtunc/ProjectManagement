...
!function (ZehraApp, $) {
    ...
    $elem.each(function () {
      ...
      for (var i = 0; i < _get_data.datasets.length; i++) {
        chart_data.push({
          label: _get_data.datasets[i].label,
          tension: .4,
          backgroundColor: ZehraApp.hexRGB(_get_data.datasets[i].color, .3),
          borderWidth: 2,
  ...
  var totalDeposit = {
    ...
    datasets: [{
      label: "Active User",
      color: [ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), ZehraApp.hexRGB("#6576ff", .2), colors.a.base],
      // @v2.0
  ...
  var totalWithdraw = {
    ...
    datasets: [{
      label: "Active User",
      color: [ZehraApp.hexRGB("#816bff", .2), ZehraApp.hexRGB("#816bff", .2), ZehraApp.hexRGB("#816bff", .2), ZehraApp.hexRGB("#816bff", .2), ZehraApp.hexRGB("#816bff", .2), ZehraApp.hexRGB("#816bff", .2), "#816bff"],
      // @v2.0
      data: [7200, 8200, 7800, 9500, 5500, 9200, 9690]
    }]
  };
  var totalBalance = {
    ...
    datasets: [{
      label: "Active User",
      color: [ZehraApp.hexRGB("#559bfb", .2), ZehraApp.hexRGB("#559bfb", .2), ZehraApp.hexRGB("#559bfb", .2), ZehraApp.hexRGB("#559bfb", .2), ZehraApp.hexRGB("#559bfb", .2), ZehraApp.hexRGB("#559bfb", .2), "#559bfb"],
      // @v2.0
  ...
  var planPurchase = {
    ...
    datasets: [{
      label: "Active User",
      color: ZehraApp.hexRGB("#6576ff", .2),
      //@v2.0
      colorHover: "#6576ff",
      //@v2.0
