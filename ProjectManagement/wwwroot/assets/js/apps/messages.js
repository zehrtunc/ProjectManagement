...
!function (ZehraApp, $) {
  ...
  var $win = $(window),
      $body = $('body'),
      breaks = ZehraApp.Break; // Messages Variable
  ...
  ZehraApp.Message = function () {
    function msg_autohide() {
      if (ZehraApp.Win.width >= flat_break) {
    ...
    function profile_overlay() {
      ...
      if (ZehraApp.Win.width < info_break && $msg_profile.hasClass('visible')) {
    ...
    function profile_trigger() {
      $toggle_info.on('click', function (e) {
        ...
        if (ZehraApp.Win.width >= flat_break) {
          ...
          } else if (ZehraApp.Win.width < info_break && !$(this).hasClass('active')) {
    ...
    function msg_on_init() {
      if (ZehraApp.Win.width >= info_break) {
        profile_show();
      } else {
        profile_hide();
      }
    ...
    function msg_on_resize() {
      ...
      if (ZehraApp.Win.width >= flat_break && ZehraApp.Win.width < info_break) {
  ...
  ZehraApp.coms.docReady.push(ZehraApp.Message);
}(ZehraApp, jQuery);