...
!function (ZehraApp, $) {
  ...
  var $win = $(window),
      $body = $('body'),
      breaks = ZehraApp.Break;

  ZehraApp.Calendar = function () {
    var today = new Date();
    ...
    var mobileView = ZehraApp.Win.width < ZehraApp.Break.md ? true : false;
  ...
  ZehraApp.coms.docReady.push(ZehraApp.Calendar);
}(ZehraApp, jQuery);