...
!function (ZehraApp, $) {
  ...
  var $win = $(window),
      $body = $('body'),
      breaks = ZehraApp.Break; // Chats Variable
  ...
  ZehraApp.Chats = function () {
    ...
    function profile_overlay() {
      ...
      if (ZehraApp.Win.width < info_break && $chat_profile.hasClass('visible')) {
  ...
  ZehraApp.coms.docReady.push(ZehraApp.Chats);
}(ZehraApp, jQuery);