...
!function (ZehraApp, $) {
  ...
  ZehraApp.EditorInit = function () {
    ZehraApp.SummerNote();
    ZehraApp.Tinymce();
    ZehraApp.Quill();
  };

  ZehraApp.coms.docReady.push(ZehraApp.EditorInit);
}(ZehraApp, jQuery);